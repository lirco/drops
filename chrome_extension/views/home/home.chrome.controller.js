...
(function () {
  ...
  function homeController($scope, $state, Authentication, AppState, Notes, $mdDialog, notes, activeTabDomain, activeTabUrl) {
    ...
    // helper function for rearranging the tags and add tag color
    ...
    self.create = function() {
      ...
      var newNote = new Notes({
        ...
        tags: generateTagsArray(self.newNote.tags)
      });
    ...
    self.update = function() {
      var editedNote = self.editedNote;
      editedNote.$update(function() {
        self.editMode = false;
        self.contentToShow = 'content';
